    ...
    <Container {...props} id="menu">
      ...
      <Cards>
        <SpecialFoodCard
          ...
          title="Ceaser Salad"
          price={19.99}
          description="The famous ceaser salad of crispy lettuce, peppers, olives and our Chicago style feta cheese, garnished with crunchy garlic and rosemary croutons."
        />
        <SpecialFoodCard
          imageUrl={bruchetta}
          title="Bruchetta"
