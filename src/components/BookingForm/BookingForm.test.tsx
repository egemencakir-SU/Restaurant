...
describe("BookingForm", () => {
  test("Renders labels and fields", () => {
    ...
    const choseDateLabel = screen.getByText("Choose date please");
    expect(choseDateLabel).toBeInTheDocument();
    const choseDateField = screen.getByTestId("res-date please");
    expect(choseDateField).toBeInTheDocument();

    const choseTimeLabel = screen.getByText("Choose time please");
